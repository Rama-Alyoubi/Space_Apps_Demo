...
if __name__ == '__main__':
	obj = three_d_object('data/3d_objects/untitled1.obj', 'data/3d_objects/planet_Bog1200.png')
	marker_colored = cv2.imread('data/m1.png') #here i add the coresponding object
